...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ballotbox.conf'
CONFIGFOLDER='/root/.ballotbox'
COIN_DAEMON='ballotboxd'
COIN_CLI='ballotbox-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ballotboxcoin/bbx/releases/download/v1.0.0/ballotbox-v1.0.0-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='ballotboxd'
COIN_EXPLORER='http://explorer.ballotbox.com'
COIN_PORT=1769
RPC_PORT=1770
